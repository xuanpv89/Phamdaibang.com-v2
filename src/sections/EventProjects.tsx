    ...
    <div className="flex flex-col items-center justify-center py-10 space-y-12">
      <div className="text-center space-y-4">
        ...
        <p className="text-white/40 text-center italic text-sm max-w-4xl">
          ...
          <br/><span className="underline decoration-white/20 underline-offset-4 cursor-pointer hover:text-white transition-colors">Click on the link to see the program introduction</span>
        </p>
      </div>
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-12 text-left">
        <div className="space-y-10">
          <div className="space-y-4">
            <h3 className="text-xl font-bold tracking-widest uppercase border-b border-white/20 pb-2">Big events and programs (participating as an initiator)</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold tracking-widest uppercase border-b border-white/20 pb-2">Community events (participating as Organizers, Operators):</h3>
            <div className="grid grid-cols-1 gap-2 text-white/70 text-[13px]">
        ...
        <div className="space-y-10">
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-3 text-white/70 text-[13px]">
          ...
          <div className="space-y-6 pt-6 border-t border-white/10">
            ...
            <ul className="space-y-4 text-sm font-light text-white/80 list-none">
              <li><span className="font-bold border-b border-white/20">Tâm Nối Tâm (Heart to heart to heart - 2021)</span>: Improvisation program between Poetry - Contemporary Dance - Music</li>
              <li><span className="font-bold border-b border-white/20">Sống Đủ Đầy/Fulfill Live (2020)</span>: The program combines activities of taking care of Body - Mind - Mind through Art - Health - Psychology</li>
              <li><span className="font-bold border-b border-white/20">Sống Như Ứng Tác (Improv Living 2021-2022)</span>: Inspiring a theme of Improv Living, with practices through writing & movement</li>
            </ul>
          </div>
        </div>
      </div>
