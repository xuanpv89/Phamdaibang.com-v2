  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 space-y-12">
      <div className="text-center space-y-4">
        ...
        <p className="text-text/40 text-center italic text-sm max-w-2xl">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-12 text-left">
        ...
        <div className="space-y-10">
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm font-light text-text/80 list-disc list-inside">
        ...
        <div className="space-y-10">
          ...
          <div className="space-y-4">
             ...
             <ul className="space-y-2 text-sm font-light text-text/80 list-disc list-inside px-1">
