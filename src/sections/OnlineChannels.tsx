        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-10">
            <div className="space-y-4 text-center">
              <div className="inline-block border-b border-border px-8 py-1 font-bold tracking-[0.2em] text-sm uppercase">
                Key Metrics
              </div>
              <p className="text-text font-black italic text-lg tracking-widest">100% ORGANIC</p>
            </div>
            
            <div className="grid grid-cols-2 gap-x-8 gap-y-6">
              <div className="text-right space-y-1">
                <span className="text-3xl font-display font-black">&gt;100.000</span>
                <p className="text-[10px] text-text/40 uppercase tracking-widest">Website visitors</p>
              </div>
              <div className="text-left space-y-1">
                <span className="text-3xl font-display font-black">&gt;3.000</span>
                <p className="text-[10px] text-text/40 uppercase tracking-widest">Contact</p>
              </div>
              <div className="text-right space-y-1">
                <span className="text-3xl font-display font-black">&gt;4000</span>
                <p className="text-[10px] text-text/40 uppercase tracking-widest">Fanpage followers</p>
              </div>
              <div className="text-left space-y-1">
                <span className="text-3xl font-display font-black">&gt;500</span>
                <p className="text-[10px] text-text/40 uppercase tracking-widest">Articles</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm font-light text-text/60">Vietnamese visitors & abroad (oversea)</p>
            </div>
            <div className="aspect-[21/9] bg-primary/5 border border-border rounded-sm flex items-center justify-center">
               <span className="text-text/20 uppercase tracking-[0.5em] text-xs">World Map Mockup</span>
            </div>
          </div>
        </div>
      </div>
